 ...
 */
export function assertHttpOrHttpsEmbeddingsUrl(urlStr) {
    let url;
    try {
        url = new URL(urlStr);
    }
    catch {
        throw new Error(`Invalid embeddings URL: ${urlStr.slice(0, 120)}${urlStr.length > 120 ? '…' : ''}`);
    }
 ...
 */
export function resolveOpenAiEmbeddingsUrl(baseUrl) {
 ...
 */
export function openAiEmbeddingsRequiresApiKey(embeddingsUrl) {
    try {
...
//# sourceMappingURL=openai-embeddings-url.js.map